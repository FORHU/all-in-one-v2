  ...
  return (
    ...
    >
      <Link
        ...
        className="group absolute left-4 top-4 flex h-10 w-10 items-center justify-center rounded-full text-[var(--shop-ink-soft)]/50 transition-colors duration-150 hover:bg-[var(--shop-ink)]/5 hover:text-[var(--shop-ink)] sm:left-8 sm:top-8"
      >
        <ArrowLeft className="h-[18px] w-[18px] transition-transform duration-150 group-hover:-translate-x-0.5" />
      </Link>
