import type { GetCategoriesParams } from "./categories.client";
...
export const categoriesKeys = {
  ...
  list: (tenantSlug: string | null, params: GetCategoriesParams = {}) =>
    [...categoriesKeys.lists(), tenantSlug, params] as const,
